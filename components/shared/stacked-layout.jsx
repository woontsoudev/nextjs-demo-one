...
export function StackedLayout({ navbar, sidebar, children }) {
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950 bg-pets-background">
      {/* Sidebar on mobile */}
      ...
      <main className="flex flex-1 flex-col pb-2 lg:px-2">
        <div className="grow p-6 lg:rounded-lg lg:bg-white lg:bg-opacity-95 lg:p-10 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
          <div className="mx-auto max-w-6xl text-black">{children}</div>
        </div>
      </main>
    </div>
  );
